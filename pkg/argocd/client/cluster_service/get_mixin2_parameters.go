...
// WithServer adds the server to the get mixin2 params
func (o *GetMixin2Params) WithServer(server string) *GetMixin2Params {
	o.SetServer(server)
	return o
}

// SetServer adds the server to the get mixin2 params
func (o *GetMixin2Params) SetServer(server string) {
	o.Server = server
}
