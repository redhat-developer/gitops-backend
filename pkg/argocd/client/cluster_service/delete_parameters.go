...
// WithServer adds the server to the delete params
func (o *DeleteParams) WithServer(server string) *DeleteParams {
	o.SetServer(server)
	return o
}

// SetServer adds the server to the delete params
func (o *DeleteParams) SetServer(server string) {
	o.Server = server
}
