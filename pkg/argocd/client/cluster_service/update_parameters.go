...
func (o *UpdateParams) WithBody(body *models.V1alpha1Cluster) *UpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update params
func (o *UpdateParams) SetBody(body *models.V1alpha1Cluster) {
	o.Body = body
}

// WithClusterServer adds the clusterServer to the update params
func (o *UpdateParams) WithClusterServer(clusterServer string) *UpdateParams {
	o.SetClusterServer(clusterServer)
	return o
}

// SetClusterServer adds the clusterServer to the update params
func (o *UpdateParams) SetClusterServer(clusterServer string) {
	o.ClusterServer = clusterServer
}
...
func (o *UpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param cluster.server
	if err := r.SetPathParam("cluster.server", o.ClusterServer); err != nil {
		return err
	}
