...
// WithServer adds the server to the list params
func (o *ListParams) WithServer(server *string) *ListParams {
	o.SetServer(server)
	return o
}

// SetServer adds the server to the list params
func (o *ListParams) SetServer(server *string) {
	o.Server = server
}
