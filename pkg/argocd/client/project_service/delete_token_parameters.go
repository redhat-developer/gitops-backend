...
// WithIat adds the iat to the delete token params
func (o *DeleteTokenParams) WithIat(iat string) *DeleteTokenParams {
	o.SetIat(iat)
	return o
}

// SetIat adds the iat to the delete token params
func (o *DeleteTokenParams) SetIat(iat string) {
	o.Iat = iat
}

// WithProject adds the project to the delete token params
func (o *DeleteTokenParams) WithProject(project string) *DeleteTokenParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the delete token params
func (o *DeleteTokenParams) SetProject(project string) {
	o.Project = project
}

// WithRole adds the role to the delete token params
func (o *DeleteTokenParams) WithRole(role string) *DeleteTokenParams {
	o.SetRole(role)
	return o
}

// SetRole adds the role to the delete token params
func (o *DeleteTokenParams) SetRole(role string) {
	o.Role = role
}
