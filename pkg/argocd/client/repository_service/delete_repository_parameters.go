...
// WithRepo adds the repo to the delete repository params
func (o *DeleteRepositoryParams) WithRepo(repo string) *DeleteRepositoryParams {
	o.SetRepo(repo)
	return o
}

// SetRepo adds the repo to the delete repository params
func (o *DeleteRepositoryParams) SetRepo(repo string) {
	o.Repo = repo
}
